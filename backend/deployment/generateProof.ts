...
export async function generateProof(runClosure: any, inputZkLoginData: Record<string, unknown>, temporaryWorkingDirectoryPath: string, proofFilePath: any) {
    ...
    executeExternalToolToCreateProof(runClosure, inputZkLoginFilePath, proofFilePath);
