...
export async function fundZkLoginAddress(scriptAddr, network: Network) {
    const sponsorWallet = getSponsorWallet(network);
    const lockTxBuilder = getTxBuilder(network);
