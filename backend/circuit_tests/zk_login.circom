pragma circom 2.2.3;
include "../circuits/nonce.circom";
include "../circuits/zkLoginId.circom";
include "../circuits/feature_inclusion_in_jwt_payload.circom";
...
//    signal input jwt_signature;
    ...
    signal input headerDotPayloadBitArray[4920]; // [0, 1, 0, ... 0, 1]
    ...
    component signature_verification = verifySignatureIsValidForHeaderDotPayload(4920);
    signature_verification.headerDotPayloadBitArray <== headerDotPayloadBitArray;
